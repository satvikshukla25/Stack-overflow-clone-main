            ...
            <form onSubmit={handleSubmit} >
                <div className="ask-form-container">
                    ...
                    <label htmlFor="ask-ques-title">
                        ...
                        <input type="text" id='ask-ques-title' onChange={(e)=>{setQuestionTitle(e.target.value)}} placeholder='e.g. Is there an R funtion for finding the index of an element in vector?'/>
                ...
                <input id='review-btn' type="submit" value='Review your question'/>
            </form>
        </div>
