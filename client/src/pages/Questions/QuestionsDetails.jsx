...
const QuestionsDetails = () => {
    ...
    const handlePostAns= (e,answerLength)=>{
        ...
        if(User===null){
            ...
            if(Answer === ''){
                ...
                dispatch(postAnswer({id, noOfAnswers: answerLength+1, answerBody:Answer, userAnswered: User.result.name,})); setAnswer("");
            }
        }
    }
    ...
    const handleShare= ()=>{
        ...
        alert('Copied_url :'+ url + location.pathname )
    }
                            ...
                            <div className="question-details-container-2">
                                ...
                                <div style={{width:"100%"}}>
                                    ...
                                    <div className="question-action-user">
                                        ...
                                        <div>
                                            <p>asked {moment(question.addedOn).fromNow()}</p>
                                            <Link to={`/User/${question.userId}`} className='user-link' style={{color:"#0086d8"}}>
                                                <Avatar backgroundColor='lightgreen'>{question.userPosted.charAt(0).toUpperCase()}</Avatar>
                                                <div>
                                                    {question.userPosted}
                                                </div>
                                            </Link>
